...
MSG_TXT = "{\"deviceId\": \"UbuntuPC\",\"time\": %d,\"x\": %.8f,\"y\": %.8f,\"z\": %.8f,\"yaw\": %.8f}" ##JSON Type!?
...
""" ~~~~~~~~~~~~~~~~~~~~ Customize ~~~~~~~~~~~~~~~~~~~~ """
def iothub_client_sample_run(flag, imu_secs, imu_x, imu_y, imu_z, imu_yaw):
    ...
    try:
        ...
        ##while True:
            ...
            for message_counter in range(0, MESSAGE_COUNT):
                IMUtime = imu_secs	#IMU: time_stamp
                IMUx = imu_x		#IMU_x
                IMUy = imu_y		#IMU_y
                IMUz = imu_z		#IMU_z
                IMUyaw = imu_yaw	#IMU_yaw
